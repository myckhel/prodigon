...
**What senior engineers do:**
- Extract migrations into a **separate deploy step**, such as a Kubernetes `Job`, a CI/CD pipeline stage, or a dedicated init container, that runs *exactly once* before the app pods come up.
...
3. Running Postgres natively and on Docker simultaneously. Port collision on 5432. Pick one per dev session.
